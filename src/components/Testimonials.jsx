...
export default function Testimonials() {
    return (
        <>
        <h2 className="text-3xl md:text-5xl font-bold mb-4 text-center p-9">Testimonios</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
            <div className="p-4 bg-gray-800 text-white flex flex-col items-center justify-center">
